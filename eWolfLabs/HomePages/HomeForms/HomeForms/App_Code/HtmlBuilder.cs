...
namespace HomeForms
{
    public class HtmlBuilder
    {
        ...
        public void AppendTable(TableCommand tc)
        {
            Append(tc.Name);
            StartTableWithBorder();
            Append(HtmlHelper.PopulateDataHeader(tc.Details));
            Append(HtmlHelper.PopulateData(tc.Details.GetStrings()));
            EndTable();
        }
